...
class AduanNonOperasi extends Model
{
    /**
    ...
    protected $table = 'ADUAN_NON_OPERASI';
    ...
    public function pelapor() {
        return $this->belongsTo('Asset\RoleUser', 'nip_pengadu', 'nip');
    }
    ...
    {
        return $this->hasMany('Asset\Models\PermohonanSc', 'aduan_non_operasi_id', 'id');
    }
