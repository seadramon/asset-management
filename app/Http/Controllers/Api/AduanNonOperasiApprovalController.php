...
class AduanNonOperasiApprovalController extends Controller
{
...
// dd($data);            
            if ($konfirmasi == 'yes') {
                ...
                kirimnotif($nipNotif,
                    [
                        'title' => $title.' Aduan Non Operasi',
                        'text' => sprintf('%s Aduan Non Operasi untuk %s', $title, $data->judul),
                        'sound' => 'default',
        ...
        try {
            ...
            if ($konfirmasi == 'yes') {
                ...
                if ($data->metode != 'eksternal emergency') {
                    ...
                    // konfirm suku cadang
                    self::confirmSc('aduan_non_operasi_id', $id);

                    if ($nextStatus == '2') {
                        // Notif penanganan
                        kirimnotif(trim($data->petugas_id),
                            [
                                'title' => 'Penanganan Aduan Non Operasi',
                                'text' => sprintf('Penanganan Aduan Non Operasi untuk %s', $data->judul),
                                'sound' => 'default',
                                'click_action' => 'OPEN_ACTIVITY_NOTIF',
                                'tipe' => 142, 
                                'id' => $id
                        ...
                        kirimnotif(trim(getMsPpp()->nip),
                            [
                                'title' => 'Approval Aduan Non Operasi',
                                'text' => sprintf('Approval Aduan Non Operasi untuk %s', $data->judul),
                                'sound' => 'default',
                                'click_action' => 'OPEN_ACTIVITY_NOTIF',
                                'tipe' => 541, 
                                'id' => $id
