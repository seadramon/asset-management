...
class Monitoring extends Command
{
     ...
     * @var string
     */
    protected $signature = 'monitoring:update';
     ...
     * @var string
     */
    protected $description = 'Update Schedule Monitoring for 4 weeks';
            ...
            foreach ($arrWeek as $weeknya) {
                ...
                foreach ($arrData as $row) {
                    ...
                    if (isset($row->ms_4w_id)) {
                        ...
                        $cek = Ms4w::where('ms_52w_id', $ms_52w_id)
...
// dd($curWeek);
    ...
    public static function getData($week)
    {
        ...
        $komponenSecond = Ms52w::select('ms_52w.*', 'aset.nama_aset', 'aset.kode_barcode', 'aset.kode_fm', 'aset.id as aset_id', 'ms_4w.id as ms_4w_id', 'ms_4w.ms_52w_id', 'ms_4w.urutan_minggu', 'ms_4w.hari', 'ms_4w.petugas', 'ms_4w.foto_lokasi')
                ...
                ->leftJoin($tbMonitor.' ms_4w', 'ms_52w.id', '=', DB::raw("ms_4w.ms_52w_id and  ms_4w.urutan_minggu = $week"))
