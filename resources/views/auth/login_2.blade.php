...
<html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Login - Aplikasi Manajemen Rapat</title>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assetlogin/admin-forms/css/epicaptcha.css')}}">
...
if (boxtest === 'true') {
    document.body.className += ' boxed-layout';
                        ...
                        <div class="row mb15 table-layout">
                            ...
                            <div class="col-xs-6 text-right va-b pr5">
                                <div class="login-links">
                                    <span class="text-white"> Aplikasi Manajemen Rapat &copy; 2015</span>
                                </div>
                        ...
                        <div class="panel panel-info mt8 br-n">
                            ...
                            <div class="panel-heading heading-border bg-white">
                                ...
                                <div class="section row mn">
                                    <div class="col-sm-6">
                                        <a href="{{route('home-link')}}" class="button btn-social btn-system dark span-left mr5 btn-block">
        ...
        <script type="text/javascript" src="{{asset('assetlogin/js/epicaptcha.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assetlogin/captcha/ui.sortable.js')}}"></script>-->
        <script type="text/javascript">
            (
                    function ($) {
                        ...
                        $.shuffle = function (arr, obj) {
                            ...
                            arr[j + 1] = arr[j];
                            arr[j] = x;
                            //if(arr[1].innerHTML!="1" ||arr[2].innerHTML!="3") obj.html($.shuffle(arr,obj))
                            //else 
                            return arr;
                        }
            ...
            $(function () {
                ...
                $('ul').shuffle();
                $("#subm").click(function () {
                    if ($('ul').validate() != false) {
                        return true;
                    } else {
                        alert('Box Belum urut');
                        return false;
                    }
                });
            });
