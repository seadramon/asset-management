...
@section('title', 'Sukucadang - Asset Management')
...
@section('pagetitle', 'Sukucadang '.ucwords($wo))
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	...
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Sukucadang {{ucwords($wo)}} Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                <!-- BEGIN FORM-->
            	<fieldset class="mb-3">
                    {!! Form::open(['url' => route('perawatan::sukucadang-simpan'), 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" id="addClone" href="#">Sukucadang</a>
                                <a class="dropdown-item" id="addWaiting" href="#">Waiting List</a>
                              </div>
                            </div>
                        </div>
                    </div>
