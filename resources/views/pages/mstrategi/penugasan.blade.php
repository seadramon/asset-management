...
@section('title', 'Penugasan - Manajemen Strategi - Asset Management')
...
@section('pagetitle', 'Penugasan - Manajemen Strategi')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Penugasan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('mstrategi::mstrategi-simpanPenugasan'), 'class' => 'form-horizontal']) !!}
                	<fieldset class="mb-3">
                		<input type="text" class="hidden" name="_token" value="{{csrf_token()}}">

                        <div class="form-group row">
							<label class="col-form-label col-lg-3">Minggu</label>
							<div class="col-lg-9">
                                {!! Form::select('minggu', $week, null, ['class'=>'form-control select2', 'id'=>'aset']) !!}
							</div>
						</div>
...
$(document).ready(function () {
    ...
    $('#aset').change(function () {
        ...
        if ($(this).val() != '') {
            $.ajax({
                type: "get",
                url: "{{url('mstrategi/PenugasanSelect')}}/" + $(this).val(),
