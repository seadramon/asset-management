...
@section('title', 'Laporan Perhitungan Efektivitas Maintenance Strategy - Asset Management')
...
@section('pagetitle', 'Laporan Perhitungan Efektivitas Maintenance Strategy')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Perhitungan Efektivitas Maintenance Strategy Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-mstrategi'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
