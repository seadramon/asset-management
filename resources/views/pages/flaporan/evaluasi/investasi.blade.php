...
@section('title', 'Rekomendasi Perbaikan dan Penggantian Aset Produksi dan Distribusi - Asset Management')
...
@section('pagetitle', 'Rekomendasi Perbaikan dan Penggantian Aset Produksi dan Distribusi')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-investasi'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
