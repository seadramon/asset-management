...
@section('title', 'Laporan Perhitungan Efektivitas Penjadwalan - Asset Management')
...
@section('pagetitle', 'Laporan Perhitungan Efektivitas Penjadwalan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Perhitungan Efektivitas Penjadwalan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-penjadwalan'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
