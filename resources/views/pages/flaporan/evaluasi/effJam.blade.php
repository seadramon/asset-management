...
@section('title', 'Laporan Perhitungan Efektivitas Jam Orang - Asset Management')
...
@section('pagetitle', 'Laporan Perhitungan Efektivitas Jam Orang')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Perhitungan Efektivitas Jam Orang Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-efektifitas-jam'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
