...
@section('title', 'Laporan Perhitungan Efektivitas Realisasi Pemeliharaan - Asset Management')
...
@section('pagetitle', 'Laporan Perhitungan Efektivitas Realisasi Pemeliharaan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Perhitungan Efektivitas Realisasi Pemeliharaan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-realisasi-pemeliharaan'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
