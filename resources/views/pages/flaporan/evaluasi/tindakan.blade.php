...
@section('title', 'Laporan Kesesuaian Pelaksanaan Perawatan dan Perbaikan - Asset Management')
...
@section('pagetitle', 'Laporan Kesesuaian Pelaksanaan Perawatan dan Perbaikan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Kesesuaian Pelaksanaan Perawatan dan Perbaikan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('evaluasi::laporan-tindakan'), 'class' => 'form-horizontal', 'target' => '_blank']) !!}
                	<fieldset class="mb-3">
