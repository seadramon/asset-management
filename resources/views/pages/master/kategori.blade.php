...
@section('title', 'Master Kategori - Asset Management')
...
@section('content') 
        ...
        <div class="card {{($data=='')?'hidden':''}}" id="kategori-form">
            ...
            <div class="card-body">
                <!-- BEGIN FORM-->
                <form action="{{route('master::kategori-simpan')}}" method="post" class="form-horizontal">
                	<fieldset class="mb-3">
	                    ...
	                    <div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control input-circle" name="nama" placeholder="Masukkan Nama Kategori" value="{{$data->name or ''}}">
							</div>
						</div>
                	</fieldset>
                	...
                	<div class="text-right">
	                    ...
	                    <a href="{{route('master::kategori-link')}}">
        ...
        <div class="card {{($data=='')?'':'hidden'}}" id="kategori-data">
            <div class="card-header header-elements-inline">
...
//    alert('aa');
    $('#tabel').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('master::kategori-data') }}",
        "columns": [
            {data: 'id'},
            {data: 'name'},
    ...
    $("#tambah-btn").click(function () {
        $("#kategori-form").removeClass('hidden');
        $("#kategori-data").addClass('hidden');
    });
});
</script>
@endsection