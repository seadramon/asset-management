...
@section('title', 'Take Over Perawatan - Asset Management')
...
@section('pagetitle', 'Take Over Perawatan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Take Over Perawatan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                <!-- BEGIN FORM-->
                @if ($data!='')
                    {!! Form::model($data, ['route' => ['perawatan::perawatan-takeover-simpan'], 'class' => 'form-horizontal']) !!}
                    {!! Form::hidden('id', null) !!}
                @else
                    {!! Form::open(['url' => route('perawatan::perawatan-takeover-simpan'), 'class' => 'form-horizontal']) !!}
                @endif
                	<fieldset class="mb-3">
