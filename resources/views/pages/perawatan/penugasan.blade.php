...
@section('title', 'Penugasan Perawatan - Asset Management')
...
@section('pagetitle', 'Penugasan Perawatan')

@section('content') 
</style>
        <!-- BEGIN PAGE BASE CONTENT -->
        <div class="card" id="mstrategi-form">
            <!-- List Detail Perawatan -->
        	...
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Penugasan Perawatan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                @endif
                <!-- BEGIN FORM-->
                {!! Form::open(['url' => route('perawatan::perawatan-penugasan-simpan'), 'class' => 'form-horizontal']) !!}
                	<fieldset class="mb-3">
...
$(document).ready(function () {
    $('#tabel').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('perawatan::perawatan-data-detail', ['id' => $id]) }}",
        "columns": [    
            // {data: 'id'},        
