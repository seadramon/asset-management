...
@section('title', 'Hasil Penanganan Perawatan - Asset Management')
...
@section('pagetitle', 'Hasil Penanganan Perawatan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	...
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Hasil Penanganan Perawatan Form</h5>
			</div>
            ...
            <div class="card-body">
                ...
                <!-- BEGIN FORM-->
                @if ($data!='')
                    {!! Form::model($data, ['route' => ['perawatan::perawatan-close'], 'class' => 'form-horizontal']) !!}
                    {!! Form::hidden('id', null) !!}
                @else
                    {!! Form::open(['url' => route('perawatan::perawatan-close'), 'class' => 'form-horizontal']) !!}
                @endif
                	<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <img src="{{ asset('uploads/perawatan/'.$data->foto_investigasi) }}" width="400px" height="400px">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">Foto Investigasi 2 :</label>
                            <div class="col-lg-10">
                                <img src="{{ asset('uploads/perawatan/'.$data->foto_investigasi2) }}" width="400px" height="400px">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <img src="{{ asset('uploads/perawatan/'.$data->foto) }}" width="400px" height="400px">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">Foto 2 :</label>
                            <div class="col-lg-10">
                                <img src="{{ asset('uploads/perawatan/'.$data->foto2) }}" width="400px" height="400px">
                            </div>
                        </div>
