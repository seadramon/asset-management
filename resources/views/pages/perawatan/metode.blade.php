...
@section('title', 'Input Metode Perawatan - Asset Management')
...
@section('pagetitle', 'Input Metode Perawatan')
...
@section('content') 
        ...
        <div class="card" id="mstrategi-form">
        	...
        	<div class="card-header header-elements-inline">
				<h5 class="card-title">Input Metode Perawatan Form</h5>
			</div>
            ...
            <div class="card-body">
            	...
            	<fieldset class="mb-3">
                    <!-- BEGIN FORM-->
                    @if ($data!='')
                        {!! Form::model($data, ['route' => ['perawatan::perawatan-metode-simpan'], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                        {!! Form::hidden('id', null, ['id' => 'id_wo']) !!}
                        {!! Form::hidden('status', null, ['id' => 'statuswo']) !!}
                    @else
                        {!! Form::open(['url' => route('perawatan::perawatan-metode-simpan'), 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                        {!! Form::hidden('id', null, ['id' => 'id_wo']) !!}
                    @endif

                    {!! Form::hidden('wo', 'prw_data_id', ['id' => 'wo']) !!}
                    ...
                    */?>
                    ...
                    <div class="text-right">
                        ...
                        <?php /*
                        <a href="{{route('perawatan::perawatan-sukucadang', ['id' => $data->id, 'aset' => $data->komponen_id])}}?wo=perawatan&fkey=prw_data_id" class="btn btn-info legitRipple" target="_blank">Sukucadang</a>
                        */?>
